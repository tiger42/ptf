...
class FunctionsPagination
{
     ...
     */
    public static function paginationFirst(array $params, View $view): string
    {
     ...
     * @return string  The generated pagination link
     */
    public static function paginationPrev(array $params, View $view): string
    {
        $pagination = $view['pagination'];
        if (!($pagination instanceof Pagination)) {
            trigger_error(__FUNCTION__ . '(): No Pagination object set', E_USER_ERROR);
     ...
     * @return string  The generated pagination link
     */
    public static function paginationNext(array $params, View $view): string
    {
        $pagination = $view['pagination'];
        if (!($pagination instanceof Pagination)) {
            trigger_error(__FUNCTION__ . '(): No Pagination object set', E_USER_ERROR);
     ...
     * @return string  The generated pagination link
     */
    public static function paginationLast(array $params, View $view): string
    {
        $pagination = $view['pagination'];
        if (!($pagination instanceof Pagination)) {
            trigger_error(__FUNCTION__ . '(): No Pagination object set', E_USER_ERROR);
     ...
     */
    public static function paginationCount(View $view): int
    {
        $pagination = $view['pagination'];
        if (!($pagination instanceof Pagination)) {
            trigger_error(__FUNCTION__ . '(): No Pagination object set', E_USER_ERROR);
